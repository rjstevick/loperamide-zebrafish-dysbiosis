...
![](GrowthCurves_S10_files/figure-html/alltogether-1.png)<!-- -->

```r
ggsave("FigureS7_GrowthCurvesLoperamide_allStrains_10.png", bg = "transparent", width = 15, height=10)
ggsave("FigureS7_GrowthCurvesLoperamide_allStrains_10.pdf", bg = "transparent", width = 15, height=10)
ggsave("FigureS7_GrowthCurvesLoperamide_allStrains_10.tiff", bg = "transparent", width = 15, height=10)
```
