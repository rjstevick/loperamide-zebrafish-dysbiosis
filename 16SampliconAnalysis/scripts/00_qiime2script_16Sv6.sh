#!/bin/bash
#SBATCH --mem=20000
#SBATCH --mail-user="rebecca.stevick@pasteur.fr"
...
cd /pasteur/zeus/projets/p02/Biofilm/rstevick/YersiniaLoperamideFlavo16S_202202
module load qiime2/2020.11.1
module list


# Put metadata file name here
METADATA="YersiniaLoperamide16Samplicon_metadata.txt"
MANIFEST="YersiniaLoperamide16Samplicon_manifest.txt"
CLASSIFIER="/pasteur/zeus/projets/p02/Biofilm/rstevick/db/qiime2/2020.11/classifier_silva-138-99-V6.qza"
